...
class ReportFoundItemPage extends StatefulWidget {
  const ReportFoundItemPage({super.key, required this.onTap});
...
class _ReportFoundItemPageState extends State<ReportFoundItemPage> {
    ...
    for (var imageFile in imageFiles) {
      try {
        final Reference storageRef = FirebaseStorage.instance
            .ref()
            .child('found_items_images/${DateTime.now().millisecondsSinceEpoch}_${imageFile.path.split('/').last}');
  ...
  Future<void> _submitReport(BuildContext context) async {
    ...
    if (form != null && form.validate()) {
      ...
      try {
        DocumentReference reportRef = await FirebaseFirestore.instance.collection('found_items').add({
