...
class FoundItemsListPage extends StatefulWidget {
  @override
  _FoundItemsListPageState createState() => _FoundItemsListPageState();
}

class _FoundItemsListPageState extends State<FoundItemsListPage> {
...
class FoundItemsListPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        builder: (context, snapshot) {
          ...
          return GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int? distanceBetweenTwoPoints;
              final userPosition = userProvider.userPosition;
